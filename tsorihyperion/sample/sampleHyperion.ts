...
class SampleHyperion
{
    ...
    async init()
    {
        ...
        var router=new EvmRouter('https://rpc.ankr.com/bsc_testnet_chapel','wss://rpc.ankr.com/bsc_testnet_chapel',tabi,'0x2018A238Fd14CE6eBb9b61D5f6Fe4b3Aeba24B5B');
        router.readEvent(false,'Claimed',26185443,ClaimedModel,this.ClaimedChanged,this,2000)
    }
